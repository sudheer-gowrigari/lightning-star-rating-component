...
import MyStarRating from 'my/starRating';
...
describe('my-star-rating', () => {
    ...
    it('contains a div that has default class names.', () => {
        ...
        const element = createElement('my-star-rating', { is: MyStarRating });
    ...
    it('override default assertions and check the component div class names', () => {
        let element = createElementWithProps('my-star-rating',
            { is: MyStarRating },
            {
                labelPosition: "right",
                size: "small",
        ...
        let EXPECTED_RATING_CLASSES = ["rating value-3 hover small disabled label-right direction-rtl space-medium hover-0"];
        ...
        //test half star
        element = createElementWithProps('my-star-rating',
            { is: MyStarRating },
            {
    ...
    it('contains a div tag that displays the label text', () => {
        const LABEL_TEXT = 'Hello';

        const element = createElementWithProps('my-star-rating',
            { is: MyStarRating },
            {
                labelPosition: "bottom",
    ...
    it('verifies hover rating selection on mouseenter', () => {
        ...
        return Promise.resolve()
            .then(() => {
                starEls[elementToClick].dispatchEvent(new MouseEvent("mouseenter", {}));
            })
            .then(() => {
                expect(onStarRatingChange).not.toHaveBeenCalledTimes(1);
            });
    ...
    it('verifies hover rating selection on mouseleave', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => {
                //on stop hover rating should not change
                expect(divEl.className.indexOf("value-" + (DEFAULT_RATING))).not.toEqual(-1);
            });
    });
